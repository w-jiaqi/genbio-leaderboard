...
Non-TATA promoter detection from the Nucleotide Transformer downstream tasks benchmark.
Sequences are 300bp DNA sequences. The task is binary classification.

**Source:** InstaDeepAI/nucleotide_transformer_downstream_tasks (HuggingFace), config `promoter_no_tata`
...
task = gl.BenchmarkTask(name='DNA/promoter-no-tata', fold='0', user='your_name')
