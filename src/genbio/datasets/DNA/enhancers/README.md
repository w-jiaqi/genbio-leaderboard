...
Enhancer element detection from the Nucleotide Transformer downstream tasks benchmark.
Sequences are 200bp DNA sequences. The task is binary classification.

**Source:** InstaDeepAI/nucleotide_transformer_downstream_tasks (HuggingFace), config `enhancers`
...
task = gl.BenchmarkTask(name='DNA/enhancers', fold='0', user='your_name')
