# H3K36me3 histone modification mark (trimethylation of histone H3 at lysine 36)
...
H3K36me3 histone modification mark (trimethylation of histone H3 at lysine 36) from the Nucleotide Transformer downstream tasks benchmark.
Sequences are 500bp DNA sequences. The task is binary classification.

**Source:** InstaDeepAI/nucleotide_transformer_downstream_tasks (HuggingFace), config `H3K36me3`
...
task = gl.BenchmarkTask(name='DNA/H3K36me3', fold='0', user='your_name')
