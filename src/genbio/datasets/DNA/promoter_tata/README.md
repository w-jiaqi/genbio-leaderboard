...
TATA-box promoter detection from the Nucleotide Transformer downstream tasks benchmark.
Sequences are 300bp DNA sequences. The task is binary classification.

**Source:** InstaDeepAI/nucleotide_transformer_downstream_tasks (HuggingFace), config `promoter_tata`
