# Acceptor splice site detection
...
Acceptor splice site detection from the Nucleotide Transformer downstream tasks benchmark.
Sequences are 141bp DNA sequences. The task is binary classification.

**Source:** InstaDeepAI/nucleotide_transformer_downstream_tasks (HuggingFace), config `splice_sites_acceptors`
